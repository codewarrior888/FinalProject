...
class MaintenanceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Maintenance
        fields = [
            'id', 'equipment_id', 'equipment_model_name', 'equipment_serial', 'maintenance_type_id','maintenance_type', 
            'maintenance_type_name', 'maintenance_date', 'engine_hours', 'order_number', 
            'order_date', 'service_company_id', 'service_company', 'service_company_name'
        ]
